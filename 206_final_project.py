...
### Compute the correlation between number of followers and number of retweets and print it out for the user to see. 
...
print("\n\nFor the Twitter users in this dataset, the correlation between users' number of followers and the number of retweets the users' tweets recieve is {}, with a p-value of {}\n\n".format(corr[0], corr[1]))
...
### Compute the correlation between IMDB rating and number of retweets and print it out for the user to see.
...
print("\n\nFor the movies in this dataset, the correlation between movies' IMDB ratings and average number of retweets movies recieve is {}, with a p-value of {}\n\n".format(corr2[0], corr2[1]))
...
### Use a list comprehension to create a new list of only movie titles with IMDb ratings higher than 7. Save this new list as best_movies, and print it for the user to see: 

all_tups = cur.fetchall()

best_movies = [tup[0] for tup in all_tups if tup[1] > 7]
print("The movies in this dataset with IMDB ratings higher than 7 are: \n")
